      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
              <div class="p-4 sm:p-6 bg-white border-b border-gray-200">
                  <!-- Wrapper untuk scroll horizontal pada mobile -->
                  <div class="overflow-x-auto -mx-4 sm:mx-0">
                      <div class="inline-block min-w-full align-middle">
                          <div class="overflow-hidden">
                                  ...
                                  <tbody class="bg-white divide-y divide-gray-200">
                                      @forelse($services as $service)
                                          <tr>
                                              ...
                                              <td class="px-3 sm:px-6 py-4">
                                                  <div class="text-sm text-gray-500 max-w-md break-words">
                                              ...
                                              <button type="button" 
                                                      @click="showDeleteModal = true; deleteUrl = '{{ route('admin.services.destroy', $service) }}'; deleteName = '{{ $service->name }}'"
                              ...
                              @empty
                                  <tr>
                                      <td colspan="5" class="px-3 sm:px-6 py-4 text-sm text-gray-500 text-center">
