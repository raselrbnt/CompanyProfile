                                      ...
                                      @forelse($messages as $message)
                                          <tr class="{{ $message->is_read ? '' : 'bg-gray-50' }}">
                                              <td class="px-3 sm:px-6 py-4">
                                                  <div class="text-sm font-medium text-gray-900 max-w-xs break-words {{ $message->is_read ? '' : 'font-semibold' }}">
                                                      {{ $message->name }}
                                                  </div>
                                              </td>
                                              <td class="px-3 sm:px-6 py-4">
                                                  <div class="text-sm text-gray-500 max-w-xs break-words {{ $message->is_read ? '' : 'font-semibold' }}">
                                                      {{ $message->email }}
                                                  </div>
                                              </td>
                                              <td class="px-3 sm:px-6 py-4">
                                              ...
                                              <button type="button" 
                                                      @click="showDeleteModal = true; deleteUrl = '{{ route('admin.messages.destroy', $message) }}'; deleteName = '{{ $message->subject }}'"
